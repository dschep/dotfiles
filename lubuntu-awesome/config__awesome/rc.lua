...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "i",     function () awful.tag.incncol( 1)         end),
    awful.key({ modkey,           }, "d",     function () awful.tag.incncol(-1)         end),
...
-- run_once("syndaemon","-i1 -k -d")
-- run_once("synclient","ClickPad=0 ClickFinger1=1 ClickFinger2=3 ClickFinger3=2 TapButton1=0 TapButton2=0 TapButton3=0 HorizTwoFingerScroll=1 VertEdgeScroll=0")
-- run_once("keepassx")
-- run_once("synology-cloud-station",nil,"/opt/Synology/CloudStation/scripts/synology-cloud-station")
-- 
-- run_once("firefox-developer-edition",nil,nil,1)
-- run_once("firefox-mozilla",nil,nil,9)
-- run_once("chromium-browser",nil,nil,8)
-- run_once("gvim",nil,nil,2)
-- run_once("gnome-terminal",nil,nil,2)
-- run_once("gnome-terminal",nil,nil,2)
